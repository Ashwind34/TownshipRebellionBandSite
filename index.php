	...
	<body>
		<div class="wrapper">
			...
			<div class="right">
				<br>
				<br>
				<p style="font-size: 24px; color: red; text-align: center;"><a href="emailform/emailform.php"><b>--JOIN OUR MAILING LIST--</b></a></p>	
				<br>
			...
			<div class="left">
				...
				<b>Facebook:</b> <a href="https://www.facebook.com/pages/Township-Rebellion/541296229218846"><u>Find us on Facebook</u></a>
				<br/>	
				<br/>
				<h3>Band Lineup</h3>
